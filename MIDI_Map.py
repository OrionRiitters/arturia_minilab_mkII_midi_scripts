...
SESSIONLEFT = 4  # Session left
SESSIONRIGHT = 5  # Session right
SESSIONUP = 2  # Session up
...
# Track Navigation
TRACKLEFT = 6  # Track left
TRACKRIGHT = 7  # Track right
...
TEMPO_BOTTOM = 0.0  # Lower limit of tempo control in BPM (min is 0)
...
TRACKSENDC = (-1,  # Track 1 Send C
              -1,  # Track 2 #All 8 params must be assigned to positive values in order for param control to work
              -1,  # Track 3
              -1,  # Track 4
              -1,  # Track 5
              -1,  # Track 6
...
PARAMCONTROL = (16,  # Track 1
              17,  # Track 2 #All 8 params must be assigned to positive values in order for param control to work
              18,  # Track 3
              19,  # Track 4
              20,  # Track 5
              21,  # Track 6
