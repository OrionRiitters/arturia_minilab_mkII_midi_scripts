...
class Arturia_MiniLab_mkII(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for Arturia_MiniLab_mkII in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in Arturia_MiniLab_mkII._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in Arturia_MiniLab_mkII._active_instances:    # Make sure you update the name
            Arturia_MiniLab_mkII._active_instances.append(self)   # Make sure you update the name
            Arturia_MiniLab_mkII._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in Arturia_MiniLab_mkII._active_instances) and Arturia_MiniLab_mkII._active_instances.remove(self):    # Make sure you update the name
